...
export const CreateBlogForm = () => {
    ...
    /**
     * Ni el contenido ni las imágenes pasan por `register`: uno es una unión
     * discriminada cuya forma cambia según el bloque, y el otro llega como
     * `FileList`. Con `watch`/`setValue` siguen dentro del mismo formulario y
     * se validan y envían con el resto en un solo submit.
     */
