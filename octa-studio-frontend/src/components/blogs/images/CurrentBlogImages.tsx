...
export const CurrentBlogImages = ({ images, name }: { images: string[]; name: string }) => {
    if (images.length === 0) {
        return <p className="text-fourth/75 text-xs lg:text-sm">Este blog no tiene imágenes.</p>;
    }
