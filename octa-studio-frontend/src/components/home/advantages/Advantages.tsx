...
import ImgRender from '@/assets/media/renders/ImgRender3.webp';
import ImgTrato from '@/assets/media/stands/ImgStand10.webp';

export const Advantages = () => {
  return (
    <section data-section="advantages" className="bg-primary py-15 lg:py-20">
      <div className="mx-auto flex max-w-[1700px] flex-col gap-10 px-5 lg:px-15">

        <div className="text-secondary flex flex-col items-center gap-2.5">
        ...
        <div className="flex snap-x snap-mandatory gap-5 overflow-x-auto overflow-y-hidden pb-5 sm:grid sm:snap-none sm:grid-cols-2 sm:overflow-visible sm:pb-0 xl:grid-cols-4">
          ...
          <Reveal
            className="bg-secondary/15 flex min-h-70 flex-col justify-between gap-5 rounded-xl p-5 sm:col-span-2 w-75 shrink-0 snap-start sm:w-auto sm:shrink"
          >
