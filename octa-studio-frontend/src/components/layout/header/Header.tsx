                    ...
                    <li key={link.href}>
                      ...
                      >
                        ...
                        <span aria-hidden="true"
                          className={`absolute inset-x-0 bottom-0 h-[1.5px] origin-left ${isActive ? 'bg-primary scale-x-100' : 'bg-primary scale-x-0 transition-transform duration-300 ease-brand group-hover:scale-x-100'}`}
                        />
                      </Link>
                    </li>
                  )
