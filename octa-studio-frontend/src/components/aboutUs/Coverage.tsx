...
import ImgPoster from '@/assets/media/stands/ImgStand20.webp';
    ...
    <section data-section="coverage" className="bg-primary py-20 lg:py-25">
      <div className="mx-auto flex max-w-[1700px] flex-col gap-10 px-5 lg:px-15">
        ...
        <div className="flex flex-col lg:flex-row gap-10 w-full">
          <Reveal variants={fadeUpScale} className="mx-auto w-full max-w-70 overflow-hidden rounded-xl sm:max-w-80 lg:mx-0 lg:w-120 lg:max-w-none">
            <video
              autoPlay
              muted
              loop
              ...
              aria-label="Montaje de Octa Building Studio en un recinto ferial"
              className="aspect-9/16 w-full object-cover lg:aspect-auto lg:h-186.5"
            >
